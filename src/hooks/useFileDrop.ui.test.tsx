...
const dragEvent = (
  type: string,
  { withFiles = true, files = [] }: { withFiles?: boolean; files?: File[] } = {}
) => {
  const e = new Event(type, { bubbles: true, cancelable: true });
  // A DragEvent's dataTransfer is read-only, and jsdom does not construct one.
  Object.defineProperty(e, 'dataTransfer', {
    value: { types: withFiles ? ['Files'] : [], files },
  });
  return e;
};
const fire = (e: Event) => act(() => void window.dispatchEvent(e));
